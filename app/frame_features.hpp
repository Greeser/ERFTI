...
#include "recognition/person_classifier.h"
#include "tracking/util/help_functions.h"
...
public:
    ...
    static void init(std::shared_ptr<FaceInception::CascadeCNN> pDetector);

    static cv::Mat target_mat;
    static std::shared_ptr<FaceInception::CascadeCNN> detector;
    static std::shared_ptr<PersonClassifier> classifier;
private:
